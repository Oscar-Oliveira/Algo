...
_ALGO_MAPA_LINHAS = {345: 8, 346: 9, 347: 10, 348: 11, 349: 12}
...
if __name__ == "__main__":
    try:
        ...
        _algo_registar_erro_runtime(_algo_msg, _algo_linha_do_erro(_algo_erro))
        sys.exit(1)
    except TypeError as _algo_erro:
        _algo_msg = f"Erro em tempo de execução: {_algo_traduzir_typeerror()}{_algo_sufixo_linha(_algo_erro)}"
        print(_algo_msg)
        _algo_registar_erro_runtime(_algo_msg, _algo_linha_do_erro(_algo_erro))
        sys.exit(1)
