...
- **Resolve**: ~~AL-07~~ (âmbito reduzido, ver AUDIT_DONE.md), ~~ARCH-01~~ (âmbito reduzido, ver AUDIT_DONE.md), ~~ARCH-02~~, ~~ARCH-03~~, ~~ARCH-04~~, ~~ARCH-05~~, ~~ARCH-06~~, ~~ARCH-13~~, ~~ARCH-15~~, ~~ON-24~~ -- Fase 6 concluída (ver AUDIT_DONE.md).
